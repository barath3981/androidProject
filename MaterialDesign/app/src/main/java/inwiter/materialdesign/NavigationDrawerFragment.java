...
public class NavigationDrawerFragment extends Fragment {
    ...
    public static final String PREF_FILE_NAME = "Hi preference";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View layout = inflater.inflate(R.layout.fragment_navigation_drawer_fragement, container, false);
        mRecyclerView = (RecyclerView) layout.findViewById(R.id.dashboard_list);
        ...
        mDrawerToggle = new ActionBarDrawerToggle(getActivity(), drawerLayout, toolbar, R.string.navigation_drawer_open, R.string.navigation_drawer_close){
            ...
            public void onDrawerOpened(View drawerView) {
                ...
                if(!mUserLearnedDrawer){
                    ...
                    saveToPreference(getActivity(), KEY_USER_LEARNED_DRAWER, mUserLearnedDrawer+"Bhanu");
                }
